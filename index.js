...
const { salesProductIdValidate, salesQuantityValidate } = require('./middlewares/salesValidate');
...
app.post('/sales', salesProductIdValidate, salesQuantityValidate, salesController.createSales);
